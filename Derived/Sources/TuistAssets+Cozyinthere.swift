...
public enum CozyinthereAsset {
  public enum Assets {
    ...
    public static let writerImage = CozyinthereImages(name: "writer.image")
  }
...
public final class CozyinthereColors {
...
public extension CozyinthereColors.Color {
  @available(iOS 11.0, tvOS 11.0, watchOS 4.0, macOS 10.13, *)
  convenience init?(asset: CozyinthereColors) {
    let bundle = CozyinthereResources.bundle
    #if os(iOS) || os(tvOS)
...
public struct CozyinthereImages {
  public fileprivate(set) var name: String
...
public extension CozyinthereImages.Image {
  @available(macOS, deprecated,
    message: "This initializer is unsafe on macOS, please use the CozyinthereImages.image property")
  convenience init?(asset: CozyinthereImages) {
    #if os(iOS) || os(tvOS)
    let bundle = CozyinthereResources.bundle
    self.init(named: asset.name, in: bundle, compatibleWith: nil)
    #elseif os(macOS)
...
public extension SwiftUI.Image {
  init(asset: CozyinthereImages) {
    let bundle = CozyinthereResources.bundle
    self.init(asset.name, bundle: bundle)
  }

  init(asset: CozyinthereImages, label: Text) {
    let bundle = CozyinthereResources.bundle
    self.init(asset.name, bundle: bundle, label: label)
  }

  init(decorative asset: CozyinthereImages) {
    let bundle = CozyinthereResources.bundle
